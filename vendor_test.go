	...
	byteValue := json.RawMessage(`
{
  ...
  "time": "2015-07-28T13:33:09.453-07:00"
	...
	require.NotNil(t, resp.Vendor.Vendor1099)
	...
	require.NotNil(t, resp.Vendor.PrintOnCheckName)
	...
	require.NotNil(t, resp.Vendor.AcctNum)
	...
	require.NotNil(t, resp.Vendor.Active)
